...
The python file milestone_5 contains then logic of the game. It will end the game when the player wins: guess the word or the player loses; has 0 live left. 
# License information
